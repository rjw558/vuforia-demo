        ...
        } else
        {
                                                                                   ...
                                                                                   // ICS device
            {
                ...
                } else
                {
                    try
                    {
                        String sourceUrl = String.format("https://s3.eu-west-2.amazonaws.com/hermes-ar-mobile-test/Mobile-AR-App/assets/%s.mp4", filename);
                        Log.i(LOGTAG, String.format("Loading video from INTERNET. [%s]", sourceUrl));
...
//                        afd.close();
            ...
            } else
            {
                try
                {
                    Log.i(LOGTAG, "Loading video from LOCAL.");
