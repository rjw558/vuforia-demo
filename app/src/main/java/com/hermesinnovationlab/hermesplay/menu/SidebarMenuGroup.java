...
public class SidebarMenuGroup {
    Activity mActivity;
    SidebarMenuInterface mMenuInterface;
    ...
    public SidebarMenuGroup(SidebarMenuInterface menuInterface,
                            Activity context, SidebarMenu parent, boolean hasTitle, String title,
                            int width)
    {
        mActivity = context;
