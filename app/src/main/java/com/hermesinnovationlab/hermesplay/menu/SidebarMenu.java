...
public class SidebarMenu
{
    ...
    private SidebarMenuAnimator mMenuAnimator;
    private Activity mActivity;
    private SidebarMenuInterface mMenuInterface;
    private GLSurfaceView mMovableView;
    private SidebarMenuView mParentMenuView;
    private LinearLayout mMovableListView;
    private ArrayList<SidebarMenuGroup> mSettingsItems = new ArrayList<SidebarMenuGroup>();
    ...
    public SidebarMenu(SidebarMenuInterface menuInterface,
                       ...
                       RelativeLayout parentView, ArrayList<View> additionalViewsToHide)
    {
        ...
        mParentMenuView = (SidebarMenuView) inflater.inflate(
        ...
        if (!mIsBelowICS)
            mMenuAnimator = new SidebarMenuAnimator(this);
        ...
        vto.addOnGlobalLayoutListener(new OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                ...
                for (SidebarMenuGroup group : mSettingsItems)
                {
    ...
    public SidebarMenuGroup addGroup(String string, boolean hasTitle)
    {
        SidebarMenuGroup newGroup = new SidebarMenuGroup(mMenuInterface,
