...
package com.hermesinnovationlab.hermesplay.vuforia.exceptions;

// Used to send back to the activity any error during vuforia processes
public class VuforiaSessionException extends Exception
{
    ...
    public VuforiaSessionException(int code, String description)
    {
        super(description);
        mCode = code;
        mString = description;
