...
public class VuforiaSession implements UpdateCallbackInterface
{
    ...
    private VuforiaSessionControl mSessionControl;
    ...
    {
        VuforiaSessionException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new VuforiaSessionException(
                VuforiaSessionException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new VuforiaSessionException(
                    VuforiaSessionException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    private void startCameraAndTrackers(int camera) throws VuforiaSessionException
    {
        String error;
        if(mCameraRunning)
        {
        	...
        	Log.e(LOGTAG, error);
            throw new VuforiaSessionException(
                VuforiaSessionException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void startAR(int camera)
    {
        ...
        catch (Exception e)
        {
            ...
            vuforiaException = new VuforiaSessionException(
                    VuforiaSessionException.CAMERA_INITIALIZATION_FAILURE,
                    logMessage);
        }
    ...
    public void stopAR() throws VuforiaSessionException
    {
        ...
        synchronized (mLifecycleLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new VuforiaSessionException(
                    VuforiaSessionException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new VuforiaSessionException(
                    VuforiaSessionException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                catch (Exception e)
                {
                    ...
                    vuforiaException = new VuforiaSessionException(
                            VuforiaSessionException.TRACKERS_INITIALIZATION_FAILURE,
                            logMessage);
                }
            }
            else
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (!result)
            {
                ...
                Log.e(LOGTAG, logMessage);
                vuforiaException = new VuforiaSessionException(
                    VuforiaSessionException.LOADING_TRACKERS_FAILURE,
                    logMessage);
            } else
            {
